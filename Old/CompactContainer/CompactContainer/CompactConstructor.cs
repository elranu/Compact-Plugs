...
using CompactContainer.Interfaces;
...
namespace CompactContainer
{
    public partial class CompactConstructor
    {
        ...
        public CompactConstructor(CContainer container, string contextName)
        {
            _ContextName = contextName;
        ...
        public void AddDefinitions(CContainer cont)
        {
        ...
        {
            _registry.AddDefinitions(XmlSerializerDeserializer.DeSerializer<CContainer>(xmlConfiguration));
        }
